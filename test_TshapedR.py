...
# test
specific_spawn_point.location.x = -45.5
specific_spawn_point.location.y = -20
specific_spawn_point.rotation.yaw = -90
...
cars = ['vehicle.tesla.model3', 'vehicle.audi.etron', 'vehicle.carlamotors.carlacola', 'vehicle.nissan.patrol_2021',
        'vehicle.mercedes.coupe_2020', 'vehicle.mercedes.sprinter', 'vehicle.lincoln.mkz_2020', 'vehicle.nissan.patrol_2021', 'vehicle.carlamotors.carlacola',
...
for i in range(0,12,2):
    ...
    spawn_point.location.y = -64.5
    spawn_point.rotation.yaw = -180
    spawn_point2.location.x = -27.8 + 10*i
    spawn_point2.location.y = -68.3
    spawn_point2.rotation.yaw = -180
...
left_display_thread = threading.Thread(target=display_camera_stream, args=(left_camera_data, 'Normal Side View Mirror'))
right_display_thread = threading.Thread(target=display_camera_stream, args=(right_camera_data, 'OSM')) #for test
