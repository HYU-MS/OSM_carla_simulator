...
# test
specific_spawn_point.location.x = 76
specific_spawn_point.location.y = 28.5
specific_spawn_point.rotation.yaw = 0
...
cars = ['vehicle.nissan.patrol_2021', 'vehicle.tesla.model3', 'vehicle.audi.etron', 'vehicle.mercedes.coupe', 'vehicle.mercedes.coupe_2020',
        'vehicle.bmw.grandtourer', 'vehicle.mercedes.sprinter', 'vehicle.lincoln.mkz_2020','vehicle.carlamotors.carlacola', 'vehicle.carlamotors.carlacola',
...
for i in range(0,8,2):
    ...
    # spawn_point.location.x = -27.8 + 10*i
    # spawn_point.location.y = -58
    # spawn_point.rotation.yaw = 0
    # spawn_point2.location.x = -27.8 + 10*i
    # spawn_point2.location.y = -61
    # spawn_point2.rotation.yaw = 0

    spawn_point.location.x = 99
    spawn_point.location.y = -30 + 5*i
    spawn_point.rotation.yaw = 90
    spawn_point2.location.x = 102.5
    spawn_point2.location.y = -30 + 5*i
